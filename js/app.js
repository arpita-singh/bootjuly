(function() {
    ...
    // Decalre cookies to speed up cookie reading
    var cookies;
    ...
    Element.prototype.addMultiEventListeners = function(e, fn) {
        var evts = e.split(' ');
    ...
    ready(function() {
        ...
        newUserField.addMultiEventListeners('keyup keydown blur focus click', function(e) {
